  ...
  <div class="app-container">
    <div v-permission="['ADMIN','ROLES_ALL','ROLES_CREATE']" style="display: inline-block;margin: 0px 2px;">
      <el-button
        ...
        size="small"
        type="primary"
        v-print="'#printTest'">打印
      </el-button>
    </div>
    <el-form ref="form" :inline="true" id="printTest" style="width: 100%" :model="form" size="large" label-width="80px" label-position='left'>
      ...
      <el-form-item type="index" label-width="350"  align="center" label="委外加工单">
        {{form.outSourceProcessSheetCode}}
      </el-form-item>
      <el-table size="mini" :data="form.outSourceInspectionCertificateProductList" border style="width: 100%" highlight-current-row
