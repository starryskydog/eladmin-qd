<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <!-- 新增 -->
      <div
        v-permission="['ADMIN','MATERIAL_INFO_ALL','MATERIAL_INFO_CREATE']"
...
import { del } from "@/api/materialCategory";
export default {
  ...
  methods: {
    checkPermission,
    handleScroll(e) {
      let h=this.$refs.viewContainer.offsetHeight
      if (h - e.target.scrollTop < 300) {
        this.count+=100
        this.data3=this.AllData.slice(0,this.count)
      }
    },
    beforeInit() {
      ...
      this.url = "api/queryMaterialCategoryPage";
