<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <span>供应商类别</span>
      <!-- 新增 -->
      <div v-permission="['ADMIN','SUPPLIER_CATEGORY_ALL','SUPPLIER_CATEGORY_CREATE']" style="display: inline-block;margin: 0px 2px;">
        <el-button
          class="filter-item"
          size="mini"
          type="primary"
      ...
      <el-col :xs="8" :sm="8" :md="4" :lg="8" :xl="7">
        <el-card class="box-card" shadow="never">
          <el-table v-loading="loading" :data="data" border highlight-current-row size="small" style="width: 100%;" @current-change="handleCurrentChange" :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}">
            <el-table-column v-if="checkPermission(['ADMIN','ROLES_ALL','SUPPLIER_CATEGORY_ALL','SUPPLIER_CATEGORY_DELETE'])" label="操作" width="130px" align="center">
...
<script>
  ...
  import { del } from '@/api/supplierCategory'
  export default {
    ...
    methods: {
      ...
      beforeInit() {
        ...
        this.url = 'api/querySupplierCategoryPage'
