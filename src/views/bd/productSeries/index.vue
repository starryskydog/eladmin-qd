<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <span>产品系列</span>
      <!-- 新增 -->
      <div v-permission="['ADMIN','PRODUCT_SERIES_ALL','PRODUCT_SERIES_CREATE']" style="display: inline-block;margin: 0px 2px;">
        <el-button
          class="filter-item"
          size="mini"
          type="primary"
      ...
      <el-col :xs="8" :sm="8" :md="4" :lg="8" :xl="7">
        <el-card class="box-card" shadow="never">
          <el-table v-loading="loading" :data="data" border highlight-current-row size="small" style="width: 100%;" @current-change="handleCurrentChange" :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}">
            <el-table-column v-if="checkPermission(['ADMIN','PRODUCT_SERIES_ALL','PRODUCT_SERIES_DELETE'])" label="操作" width="130px" align="center">
            ...
            <el-table-column prop="productSeriesName" label="产品系列名称"/>
          </el-table>
          <!--分页组件-->
          <el-pagination
            :total="total"
...
<script>
  ...
  import { del } from '@/api/productSeries'
  export default {
    name:'productSeries',
    components: { eForm },
    mixins: [initData],
    ...
    methods: {
      ...
      beforeInit() {
        ...
        this.url = 'api/queryProductSeriesPage'
